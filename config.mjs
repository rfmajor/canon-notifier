...
config.sms.recipients = ["+48515050764"];
config.sms.messagingServiceId = "MGb1ec5e8e4e7b2608d79542695b053f7b";
config.mail.recipients = ["rfmajor99@gmail.com", "alicia01kl@gmail.com"];
config.mail.sender = "canon-availability@filipmajor.com";
config.call.recipients = ["+48515050764"];
...
config.twilio.secrets = ["shopping-api-key", "shopping-api-sid"];
config.sendGrid = {};
config.sendGrid.secretName = "sendgrid-keys";
config.sendGrid.secrets = ["sendgrid-api-key"];
